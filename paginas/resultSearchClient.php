...
if(isset($_POST['cpfBuscado'])){
    $cpfBuscado = mysqli_real_escape_string($connect, trim($_POST['cpfBuscado']));
}
$sql = "SELECT * FROM clientes WHERE cpf LIKE '$cpfBuscado'";
mysqli_set_charset($connect, "utf8");
$resultadoCliente = mysqli_query($connect, $sql);
$rowDados = mysqli_fetch_assoc($resultadoCliente);
?>
            ...
            <form class="col s12" action="../_phpaction/actionUpdateClient.php" method="post">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input id="first_name" readOnly type="text" class="validate" name="first_name" maxlength="100" value="<?php echo $rowDados['nome'] ?>">
